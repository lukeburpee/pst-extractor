    ...
    public static createAppropriatePSTMessageObject(
        ...
        switch (messageClass) {
            ...
            case 'IPM.Note.Agenda':
                ...
                // Log.debug(msg.body);
                // Log.debug(msg.numberOfRecipients.toString());
                // Log.debug(msg.colorCategories.toString());
            ...
            case 'REPORT.IPM.Note.IPNRN':
                // Read receipt
                // debugger;
                Log.debug('PSTUtil::createAppropriatePSTMessageObject REPORT.IPM.Note.IPNRN');
                return new PSTMessage(theFile, folderIndexNode, table, localDescriptorItems);
            case 'REPORT.IPM.Note.IPNNRN':
                // Not-read notification
                // debugger;
                Log.debug('PSTUtil::createAppropriatePSTMessageObject REPORT.IPM.Note.IPNNRN');
                return new PSTMessage(theFile, folderIndexNode, table, localDescriptorItems);
            case 'IPM.Schedule.Meeting.Request':
                // Meeting request
                // debugger;
                Log.debug('PSTUtil::createAppropriatePSTMessageObject IPM.Schedule.Meeting.Request');
                return new PSTMessage(theFile, folderIndexNode, table, localDescriptorItems);
            case 'REPORT.IPM.Note.DR':
                // Delivery receipt
                // debugger;
                Log.debug('PSTUtil::createAppropriatePSTMessageObject REPORT.IPM.Note.DR');
                return new PSTMessage(theFile, folderIndexNode, table, localDescriptorItems);
            default:
